package com.luckyluke.util.file;
...
public class PoiUtil {
	...
	public HSSFCellStyle titlev12(HSSFWorkbook wb, HSSFFont blackFont) {
		...
		curStyle.setVerticalAlignment(VerticalAlignment.CENTER); // 单元格垂直居中VerticalAlignment.CENTER
	...
	public HSSFCellStyle moneyrv10_BorderThin(HSSFWorkbook wb, HSSFFont defaultFont10, short rmb4Format) {
		...
		curStyle.setAlignment(HorizontalAlignment.RIGHT);//HorizontalAlignment.RIGHT
		curStyle.setVerticalAlignment(VerticalAlignment.CENTER); // 单元格垂直居中
	...
	public HSSFCellStyle notet10(HSSFWorkbook wb) {
		...
		curStyle.setVerticalAlignment(VerticalAlignment.TOP); // 单元格垂直居中VerticalAlignment.TOP
	...
	public HSSFCellStyle notehv10(HSSFWorkbook wb, HSSFFont defaultFont10) {
		...
		curStyle.setAlignment(HorizontalAlignment.CENTER);//HorizontalAlignment.CENTER
		curStyle.setVerticalAlignment(VerticalAlignment.CENTER); 	// 单元格垂直居中
	...
	public HSSFCellStyle notehlv10(HSSFWorkbook wb, HSSFFont defaultFont10) {
		...
		curStyle.setAlignment(HorizontalAlignment.LEFT);//HorizontalAlignment.LEFT
		curStyle.setVerticalAlignment(VerticalAlignment.CENTER); // 单元格垂直居中
