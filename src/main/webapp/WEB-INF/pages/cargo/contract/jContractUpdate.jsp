                ...
                <table class="commonTable" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="tableContentAuto">
                            <input type="radio" name="printStyle" value="2" class="input"
                    ...
                    <tr>
                        ...
                        <td class="tableContentAuto">
                            <input type="radio" name="importNum" value="3" class="input"
                                   <c:if test="${obj.importNum==3}">checked</c:if>>★★★
                            <input type="radio" name="importNum" value="2" class="input"
                                   <c:if test="${obj.importNum==2}">checked</c:if>>★★
                            <input type="radio" name="importNum" value="1" class="input"
                                   <c:if test="${obj.importNum==1}">checked</c:if>>★
                        </td>
                    </tr>
                    <tr>
